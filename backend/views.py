...
from backend.chart_datas import total_reg_ents_bar, total_eln_ents_bar, reg_ents_per_user_line, eln_mods_per_user_line, cell_line_health, plasmid_health, reg_ents_per_user_bar
...
class ChartView(TemplateView):
	...
	def get_context_data(self, **kwargs):
		...
		context['context_charts'] = {
			...
			'reg_ents_per_user_bar': reg_ents_per_user_bar(self.team_name),
			# the modifications only show the last mod date per eln...not total mods so I think thats easy to misinterpret
